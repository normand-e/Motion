...
mainTL.to("#apartment", {duration:.5, scaleX: 0,transformOrigin: "100% center", ease: "sine.inOut", yoyo:true}, "start")
mainTL.to("aptDark", {duration: 2, x:"+=200", y:"-=200"}, "start-=.5")
...
mainTL.to("#heart", {duration:.25, scale:.75, ease:"power3.out"}, "second")
