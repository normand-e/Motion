...
mainTL.set("#slide-middle", {alpha:0})
mainTL.set("#slide-left", {alpha:0})
mainTL.set("#trulia-text", {alpha:0})
mainTL.set("#apartment-dark", {alpha:0})
...
mainTL.to("#apartment", {duration:1, drawSVG:"100%", ease:'linear', rotationY:180, transformOrigin: "100% 50%"}, "start")
...
mainTL.to("trulia-text", {duration:.25, y:-100, alpha:1})
