...
function headText(){ //hero text section1 animation
...
function heroAnimation(){ //change opacity of background hero image
    let tl = gsap.timeline({
        scrollTrigger:{
            trigger:"#section-1",
            start:"bottom bottom",
...
function studioAnimation(){ //scroll in text section2
    let tl = gsap.timeline({
        scrollTrigger:{
            trigger:"#section-2",
            start:"top 70%",
...
function albumImagesAnim(){ //scroll trigger scale change album images
    let tl = gsap.timeline({
        scrollTrigger:{
            trigger:".albImg",
            start:"top 100%",
...
function albumText(){ //hover animation for album names
    let tl = gsap.timeline();
